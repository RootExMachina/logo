...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400">
    <!-- Fundo do terminal -->
    <rect width="300" height="200" fill="black" rx="10" ry="10" />
    
    <!-- Cabecalho do terminal -->
    <rect width="300" height="30" fill="#333" rx="10" ry="10" />
    ...
    <!-- Texto do terminal -->
    <text x="20" y="70" font-size="44">
        ~# whoami
    </text>
    <text x="20" y="110" font-size="44">
        root
    </text>
    <text x="20" y="160" font-size="44">
        ~# █
    </text>
